...
export default function HomePage() {
  ...
  const featuredCitySlugs = ['san-jose', 'san-francisco', 'oakland', 'houston', 'dallas', 'austin', 'miami', 'tampa', 'orlando', 'jacksonville', 'fort-lauderdale', 'fort-worth'];
    ...
    <>
        ...
        <div className="mx-auto max-w-5xl px-4 py-6">
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 md:text-sm">State</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <p className="mb-10 text-center text-gray-500">Coverage across major contractor markets in California, Texas, and Florida.</p>
